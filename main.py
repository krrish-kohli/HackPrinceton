...
def speak(text: str) -> None:
    # cache audio so we don't re-generate the same phrase
    if text not in AUDIO_CACHE:
        ...
        AUDIO_CACHE[text] = b"".join(stream)  # join chunks once
    play(AUDIO_CACHE[text])  # now this is the function from elevenlabs.play
...
while True:
    ...
    # Draw a whitespace for loading bar
